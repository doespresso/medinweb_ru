<?php /* Smarty version Smarty-3.1.15, created on 2014-03-23 22:07:17
         compiled from "/Users/jd/servers/LOCALHOST/medinweb.ru/public/design/backend/templates/views/debugger/debugger.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27679564532f22d53e4dc8-78377672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb6f1e492c8166ee584d6c61a22e658475c812e3' => 
    array (
      0 => '/Users/jd/servers/LOCALHOST/medinweb.ru/public/design/backend/templates/views/debugger/debugger.tpl',
      1 => 1395142068,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '27679564532f22d53e4dc8-78377672',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_532f22d55d4c25_90603174',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_532f22d55d4c25_90603174')) {function content_532f22d55d4c25_90603174($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/Users/jd/servers/LOCALHOST/medinweb.ru/public/app/functions/smarty_plugins/function.script.php';
...
/debugger/logo.png"></a>
        <?php if (@constant('DEBUG_MODE')!==true) {?>
            <?php $_smarty_tpl->tpl_vars['current_url'] = new Smarty_variable(fn_query_remove($_smarty_tpl->tpl_vars['config']->value['current_url'],"debug"), null, 0);?>
...
" data-ca-target-id="DebugToolbarTabTemplatesContent" data-tab-content-id="#DebugToolbarTabTemplates" >Templates<small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['totals']->value['count_tpls'], ENT_QUOTES, 'UTF-8');?>
 ...
 KB</small></li>
            ...
            <?php } elseif (fn_allowed_for("MULTIVENDOR")) {?>
                <li>Debug on <a href="<?php echo htmlspecialchars(fn_url("?debug=".((string)$_smarty_tpl->tpl_vars['debugger_id']->value),'C'), ENT_QUOTES, 'UTF-8');?>
" target="_blank" >storefront</a></li>
            <?php } else { ?>
                <li>Debug on <a href="<?php echo htmlspecialchars(fn_url("?debug=".((string)$_smarty_tpl->tpl_vars['debugger_id']->value)."&company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_id']),'C'), ENT_QUOTES, 'UTF-8');?>
" target="_blank" >storefront</a></li>
            <?php }?>
        </ul>
        </div>
